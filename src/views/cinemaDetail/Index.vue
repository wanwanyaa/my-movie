<template>
  <div class="cinema-d">
    <div class="cinema-head">
      <div class="c-left">
        <i class="iconfont icon-zuo c-i"></i>
      </div>
      <h1>观华全色彩激光影城(盒马鲜生店)</h1>
    </div>
    <div class="cinema-body">
      <div class="body-con">
        <div class="con-top">
          ...
          <div class="film-con">
            <van-swipe class="swiper-film" :autoplay="3000" indicator-color="block" :width="100" :height="135">
              <van-swipe-item class="swiper-con">1</van-swipe-item>
              <van-swipe-item class="swiper-con">2</van-swipe-item>
              <van-swipe-item class="swiper-con">3</van-swipe-item>
            </van-swipe>
